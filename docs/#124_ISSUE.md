...
- Treat `01disney`'s later Android 16 / POCO F6 Pro / Boshiamy first-input IME auto-close report in https://github.com/lime-ime/limeime/issues/124#issuecomment-4786153001 as an adjacent likely-separate stability/focus symptom unless maintainer evidence connects it to the popup-placement work; prefer a separate issue or targeted follow-up rather than broadening #124 silently.
