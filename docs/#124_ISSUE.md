...
- Status: **OPEN / v6.1.23 popup fix delivered; v6.1.26 auto Chinese punctuation fix delivered; remaining candidate-strip X tap-target usability follow-up is tracked for a later Android release** (reopened 2026-06-21)
