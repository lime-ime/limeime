...
- **Closed / APK-delivered, awaiting device verification.** #128 remains closed after the PR #133 merge. GitHub APK `LIMEHD2026-6.1.25.apk` now contains merge commit `6791f14a06047047c39dc53875ce2ebaebcf1327` and the PR #133 haptic/sound-volume follow-up.
