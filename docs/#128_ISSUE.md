...
- Next verification: optional Pixel / Android 17 keypress vibration and sound QA on v6.1.26; optional Samsung A17 stronger vibration levels and `keypress_sound_volume` QA. Pixel regular-key sound audibility is tracked separately in open PR #134 (`7205b3f49014501c6f615253d04bc5a29dfad211`) and should not be considered included in v6.1.26 unless that PR is merged and a newer APK is built.
