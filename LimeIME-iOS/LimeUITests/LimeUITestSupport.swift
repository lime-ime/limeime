...
class LimeUITestSupport: XCTestCase {

    override func setUpWithError() throws {
        continueAfterFailure = false
    }

    func focusSafariAddressField(in safari: XCUIApplication) throws -> XCUIElement {
        safari.activate()
    ...
    func activeTextField(in app: XCUIApplication, fallback: XCUIElement) -> XCUIElement {
    ...
    func switchToLimeIME(in app: XCUIApplication) throws {
    ...
    func switchToEnglishIfNeeded(in app: XCUIApplication) {
    ...
    func keyCoordinate(in app: XCUIApplication,
                       labels: [String],
    ...
    func focusedText(in app: XCUIApplication, fallback: XCUIElement) -> String {
        let field = activeTextField(in: app, fallback: fallback)
        return field.value as? String ?? ""
    }

    func hasLimeKeyboardSignal(in app: XCUIApplication) -> Bool {
    ...
    func dismissSafariFirstLaunch(in app: XCUIApplication) {
