...
final class TableSyncEngine {
    ...
    private func processEditorRefreshRequestIfNeeded() throws {
        ...
        do {
            ...
            // Settings owns only brief publish/reacquire windows. Defer this request to the
            // next scan rather than aborting unrelated cold→hot synchronization in this pass.
            return
        }
