...
enum IMCatalog {
    ...
    static let families: [IMFamily] = [
        ...
        .init(
            ...
            systemIcon: "textformat.alt",
            variants: [
                .init(id: "tricode", name: "三碼字元", filename: "tricode.limedb", tableName: "tricode", imName: "tricode", label: "三碼", keyboardId: "limenumsym2", recordCount: 23_359, compressedKB: 355),
            ]
        ),
        .init(
            id: "ez",
