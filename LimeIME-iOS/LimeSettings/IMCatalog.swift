...
enum IMCatalog {
    ...
    static let families: [IMFamily] = [
        ...
        .init(
            ...
            systemIcon: "square.grid.2x2",
            variants: [
                .init(id: "cj4", name: "哈哈倉頡", filename: "hahacj.limedb", tableName: "cj4", imName: "cj4", label: "哈哈倉頡", keyboardId: "cjnum", recordCount: 33_044, compressedKB: 720),
            ]
        ),
        .init(
            id: "cj5",
        ...
        .init(
            ...
            systemIcon: "textformat.alt",
            variants: [
                .init(id: "tricode", name: "三碼 v.20260720.3", filename: "tricode.limedb", tableName: "tricode", imName: "tricode", label: "三碼", keyboardId: "limenumsym2", recordCount: 14_489, compressedKB: 234),
            ]
        ),
        .init(
            id: "ez",
