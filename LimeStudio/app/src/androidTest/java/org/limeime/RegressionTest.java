...
//    }
    ...
    private static void downloadCloudDbAndImport(String tableName, String url,
                                                 org.limeime.SearchServer searchServer,
    ...
    public void setUp() {
        ...
        searchServer = new org.limeime.SearchServer(context);
    ...
    public void test_8_4_ScoreUpdateAfterSelection() throws Exception {
        ...
        if (startScore != -1) {
             ...
             org.limeime.data.Record r = new org.limeime.data.Record();
             r.setCode(code);
             r.setWord(word);
    ...
    public void test_8_4_1_LearnRelatedPhraseAndUpdateScore() throws Exception {
        ...
        // Wait for async thread to complete (poll up to ~3s)
        int attempts = 0;
        do {
            Thread.sleep(200);
