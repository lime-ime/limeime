...
public class IntegrationTestBackupRestore {
    ...
    public void test_5_6_7_TxtTableBackupRestoreWorkflow() {
        ...
        try {
            ...
            java.util.List<org.limeime.data.Record> originalRecords = queryRecords(testTableName, null, true);
            ...
            int recordChecked = 0;
            int missingCount = 0;
            for (org.limeime.data.Record r : originalRecords) {
            ...
            java.util.List<org.limeime.data.Record> restoredRecords = queryRecords(testTableName, null, true);
            java.util.Map<String, java.util.Set<String>> restoredMap = new java.util.HashMap<>();
            for (org.limeime.data.Record r : restoredRecords) {
    ...
    public void test_5_6_8_BackupRestoreUserRecordsPair() {
        ...
        try {
            ...
            java.util.List<org.limeime.data.Record> beforeImport = queryRecords(testTableName, code, true);
            ...
            java.util.List<org.limeime.data.Record> afterImport = queryRecords(testTableName, code, true);
            Integer score1 = null;
            Integer score2 = null;
            for (org.limeime.data.Record r : afterImport) {
