...
public class IntegrationTestSearchServerDBServer {
    ...
    public void test_5_1_CompleteSearchFlow() {
        ...
        java.util.List<org.limeime.data.Record> results = queryRecords(testTableName, "j6", true);
        ...
        org.limeime.data.Record first = results.get(0);
    ...
    public void test_5_1_CachingBehavior() {
        ...
        java.util.List<org.limeime.data.Record> results1 = queryRecords(testTableName, testCode, true);
        ...
        java.util.List<org.limeime.data.Record> results2 = null;
    ...
    public void test_5_1_ErrorHandlingPropagation() {
        java.util.List<org.limeime.data.Record> results = queryRecords(testTableName, "invalid_code_" + System.currentTimeMillis(), true);
    ...
    public void test_5_1_ConfigurationSetImConfig() {
        java.util.List<org.limeime.data.Keyboard> keyboards = manageController.getKeyboardList();
    ...
    public void test_5_4_ImportDbMergesImKeyboardRow() {
        org.limeime.SearchServer ss = new org.limeime.SearchServer(context);
        java.util.List<org.limeime.data.ImConfig> rows =
        ...
        org.limeime.data.ImConfig kbRow = rows.get(0);
    ...
    public void test_5_4_GetCurrentKeyboardAfterCloudInstall() {
        org.limeime.data.Keyboard kb = manageController.getCurrentKeyboard(LIME.IM_PINYIN);
