...
public class IntegrationTestUISearchServer {
    ...
    private static org.limeime.DBServer staticDbServer;
    private static boolean imTablesReady = false;

    private Context context;
    private SetupImController setupController;
    private org.limeime.ui.controller.ManageImController manageController;
    private String testTableName;

    @BeforeClass
    public static void setUpClass() throws Exception {
        staticContext = InstrumentationRegistry.getInstrumentation().getTargetContext();
        org.limeime.SearchServer ss = new org.limeime.SearchServer(staticContext);
        org.limeime.DBServer ds = org.limeime.DBServer.getInstance(staticContext);
        staticDbServer = ds;
        ...
        org.limeime.ui.controller.ManageImController tempController = 
            new org.limeime.ui.controller.ManageImController(ss);
    ...
    private static void downloadCloudDbAndImport(String tableName, String url,
                                                 org.limeime.ui.controller.ManageImController manageController,
                                                 org.limeime.DBServer dbServer) {
    ...
    public void setUp() {
        ...
        org.limeime.SearchServer ss = new org.limeime.SearchServer(context);
        org.limeime.DBServer ds = org.limeime.DBServer.getInstance(context);
        setupController = new SetupImController(context, ds, ss);
        manageController = new org.limeime.ui.controller.ManageImController(ss);

        testTableName = org.limeime.global.LIME.DB_TABLE_CUSTOM;
    ...
    public void test_5_3_1_DataFlowTransformations() {
        ...
        java.util.List<org.limeime.data.Record> results = queryRecords(testTableName, "transform", true);
        assertNotNull("Results should not be null", results);
        assertFalse("Results should not be empty", results.isEmpty());
        org.limeime.data.Record r = results.get(0);
    ...
    public void test_5_3_2_ErrorHandlingOnNetworkFailures() throws Exception {
        int before = setupController.countRecords(org.limeime.global.LIME.IM_PHONETIC);
        setupController.downloadAndImportZippedDb(org.limeime.global.LIME.IM_PHONETIC, "http://invalid.invalid/doesnotexist.zip", false);
        Thread.sleep(3000);
        int after = setupController.countRecords(org.limeime.global.LIME.IM_PHONETIC);
    ...
    public void test_5_3_2_HotPathQueryLatency() {
        ...
        java.util.List<org.limeime.data.Record> coldResults = queryRecords(testTableName, "hot50", true);
        long startWarm = System.nanoTime();
        java.util.List<org.limeime.data.Record> warmResults = queryRecords(testTableName, "hot50", true);
    ...
    public void test_5_3_2_CacheWarmthVerification() {
        ...
        java.util.List<org.limeime.data.Record> result1 = queryRecords(testTableName, "cache_test", true);
        java.util.List<org.limeime.data.Record> result2 = queryRecords(testTableName, "cache_test", true);
        java.util.List<org.limeime.data.Record> result3 = queryRecords(testTableName, "cache_test", true);
    ...
    public void test_5_3_2_DualCodeExpansionAndBlacklist() {
        ...
        java.util.List<org.limeime.data.Record> results = queryRecords(testTableName, "dual", true);
        assertNotNull("Results should not be null", results);
        assertFalse("Results should not be empty", results.isEmpty());
    ...
    public void test_5_3_3_LearnedEntriesInfluenceResults() {
        ...
        java.util.List<org.limeime.data.Record> results = queryRecords(testTableName, "learn", true);
        ...
        for (org.limeime.data.Record r : results) {
    ...
    public void test_5_3_3_CacheRespectsLearningUpdates() {
        ...
        java.util.List<org.limeime.data.Record> initialResults = queryRecords(testTableName, "update", true);
        int initialSize = initialResults.size();
        manageController.addRecord(testTableName, "update", "學習新詞", 150);
        java.util.List<org.limeime.data.Record> updatedResults = queryRecords(testTableName, "update", true);
    ...
    public void test_5_3_3_BlacklistNotSuppressLearned() {
        ...
        java.util.List<org.limeime.data.Record> results = queryRecords(testTableName, "special", true);
        assertNotNull("Results should not be null", results);
        assertFalse("Learned entry should not be filtered out", results.isEmpty());
    }


    private java.util.List<org.limeime.data.Record> queryRecords(String table, String query, boolean searchByCode) {
        final java.util.concurrent.CountDownLatch latch = new java.util.concurrent.CountDownLatch(1);
        final java.util.concurrent.atomic.AtomicReference<java.util.List<org.limeime.data.Record>> out = new java.util.concurrent.atomic.AtomicReference<>();
        manageController.setManageImView(new org.limeime.ui.view.ManageImView() {
            @Override public void displayRecords(java.util.List<org.limeime.data.Record> records) { out.set(records); latch.countDown(); }
            @Override public void updateRecordCount(int count) {}
            @Override public void showAddRecordDialog() {}
            @Override public void showEditRecordDialog(org.limeime.data.Record record) {}
        ...
        java.util.List<org.limeime.data.Record> result = out.get();
