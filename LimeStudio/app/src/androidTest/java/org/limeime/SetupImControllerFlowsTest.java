...
public class SetupImControllerFlowsTest {
    ...
    public void textImportFlow_ApisExist() throws Exception {
        Class<?> controller = Class.forName("org.limeime.ui.controller.SetupImController");
        Class<?> searchServer = Class.forName("org.limeime.SearchServer");
        Class<?> dbServer = Class.forName("org.limeime.DBServer");
    ...
    public void downloadAndImportFlow_ApisExist() throws Exception {
        Class<?> controller = Class.forName("org.limeime.ui.controller.SetupImController");
        Class<?> utilities = Class.forName("org.limeime.global.LIMEUtilities");
        Class<?> searchServer = Class.forName("org.limeime.SearchServer");
        ...
        if (!hasHandler) {
            ...
            Class<?> base;
            try {
                base = Class.forName("org.limeime.ui.controller.BaseController");
