...
import org.limeime.ui.IntentHandler;
        ...
        try (ActivityScenario<LIMESettings> scenario = ActivityScenario.launch(LIMESettings.class)) {
            scenario.onActivity(activity -> {
                try {
                    ...
                    if (dialog instanceof org.limeime.ui.dialog.ImportDialog) {
                        ((org.limeime.ui.dialog.ImportDialog) dialog).dismissAllowingStateLoss();
                    }
