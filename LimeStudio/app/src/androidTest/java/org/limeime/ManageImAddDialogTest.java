...
public class ManageImAddDialogTest {
    ...
    public void testManageImAddDialogClassExists() {
        try {
            Class<?> cls = Class.forName("org.limeime.ui.dialog.ManageImAddSheet");
            assertNotNull(cls);
    ...
    public void testValidationAndControllerAddApis() throws Exception {
        Class<?> dialog = Class.forName("org.limeime.ui.dialog.ManageImAddSheet");
    ...
    public void testSheetLayoutScrollsWhenImeIsVisible() {
        ...
        assertEquals("ManageImAddSheet root should scroll above the soft keyboard",
                "androidx.core.widget.NestedScrollView",
                getRootTagName(context, R.layout.sheet_manage_im_add));
    }
    ...
    public void testSheetMatchesIosRowEditorControls() {
        ...
        assertNotEquals("Add sheet should expose a cancel button",
                0, R.id.btn_cancel);
        assertNotEquals("Add sheet should expose an editable score field",
                0, R.id.edt_score);
    }
