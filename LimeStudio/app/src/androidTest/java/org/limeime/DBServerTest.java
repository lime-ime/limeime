...
public class DBServerTest {
            ...
            try {
                ...
                if (datasource != null) {
                    ...
                    try {
                        ...
                        java.lang.reflect.Field threadField = org.limeime.limedb.LimeDB.class.getDeclaredField("importThread");
    ...
    public void testDBServerImportMapping() {
        ...
        try {
            ...
            org.limeime.limedb.LimeDB limeDB = new org.limeime.limedb.LimeDB(appContext);
            ...
            LIMEUtilities.copyRAWFile(appContext.getResources().openRawResource(org.limeime.R.raw.blank), tempDb);
    ...
    public void backupDatabaseSkipsMissingRollbackJournal() throws Exception {
        ...
        try {
            ...
            assertTrue("Backup zip should contain preference manifest",
                    entries.contains(org.limeime.global.PreferenceBackupAdapter.MANIFEST_PATH));
...
// Method returned null, which is acceptable for invalid tableName
    ...
    public void testDBServerImportBackupRelatedDbDelegation() {
        ...
        try {
            ...
            LIMEUtilities.copyRAWFile(appContext.getResources().openRawResource(org.limeime.R.raw.blankrelated), tempBackup);
    ...
    public void testDBServerImportBackupDbDelegation() {
        ...
        try {
            ...
            // Copy blank database template (required for prepareBackup to work)
            LIMEUtilities.copyRAWFile(appContext.getResources().openRawResource(org.limeime.R.raw.blank), tempBackup);
    ...
    public void testDBServerExportZippedDbRelatedAndImportWithDataConsistency() {
        ...
        try {
            ...
            // Verify specific records exist
            org.limeime.data.Mapping related1 = limeDB.isRelatedPhraseExist(pword1, cword1);
            org.limeime.data.Mapping related2 = limeDB.isRelatedPhraseExist(pword2, cword2);
            org.limeime.data.Mapping related3 = limeDB.isRelatedPhraseExist(pword3, cword3);
            ...
            org.limeime.data.Mapping importedRelated1 = limeDB.isRelatedPhraseExist(pword1, cword1);
            org.limeime.data.Mapping importedRelated2 = limeDB.isRelatedPhraseExist(pword2, cword2);
            org.limeime.data.Mapping importedRelated3 = limeDB.isRelatedPhraseExist(pword3, cword3);
    ...
    public void testDBServerExportZippedDbAndImportWithDataConsistency() {
        ...
        try {
            ...
            // Verify specific records exist
            List<org.limeime.data.Mapping> mappings1 = limeDB.getMappingByCode(code1, true, false);
            List<org.limeime.data.Mapping> mappings2 = limeDB.getMappingByCode(code2, true, false);
            List<org.limeime.data.Mapping> mappings3 = limeDB.getMappingByCode(code3, true, false);
            ...
            // Step 8: Verify specific records exist after import
            List<org.limeime.data.Mapping> importedMappings1 = limeDB.getMappingByCode(code1, true, false);
            List<org.limeime.data.Mapping> importedMappings2 = limeDB.getMappingByCode(code2, true, false);
            List<org.limeime.data.Mapping> importedMappings3 = limeDB.getMappingByCode(code3, true, false);
            ...
            for (org.limeime.data.Mapping m : importedMappings1) {
                if (word1.equals(m.getWord())) {
                    foundWord1 = true;
                    break;
                }
            }
            for (org.limeime.data.Mapping m : importedMappings2) {
                if (word2.equals(m.getWord())) {
                    foundWord2 = true;
                    break;
                }
            }
            for (org.limeime.data.Mapping m : importedMappings3) {
    ...
    public void testDBServerBackupDatabaseAndRestoreWithDataConsistency() {
        ...
        try {
            ...
            List<org.limeime.data.Mapping> restoredMappings1 = limeDB.getMappingByCode(code1, true, false);
            List<org.limeime.data.Mapping> restoredMappings2 = limeDB.getMappingByCode(code2, true, false);
            org.limeime.data.Mapping restoredRelated = limeDB.isRelatedPhraseExist(pword1, cword1);
    ...
    public void testDBServerExportTxtTableRelatedAndImportTxtTablePair() {
        ...
        try {
            ...
            List<org.limeime.data.Related> originalRecords = limeDB.getRelated(null, 0, 0);
            ...
            java.util.Map<String, org.limeime.data.Related> originalMap = new java.util.HashMap<>();
            for (org.limeime.data.Related r : originalRecords) {
            ...
            try {
                ...
                List<org.limeime.data.Related> restoredRecords = limeDB.getRelated(null, 0, 0);
                java.util.Map<String, org.limeime.data.Related> restoredMap = new java.util.HashMap<>();
                for (org.limeime.data.Related r : restoredRecords) {
                    if (r.getPword() != null && r.getCword() != null && 
                        !r.getPword().isEmpty() && !r.getCword().isEmpty()) {
                        String key = r.getPword() + "|" + r.getCword() + "|" + r.getBasescore() + "|" + r.getUserscore();
                ...
                for (String key : originalMap.keySet()) {
                    if (!restoredMap.containsKey(key)) {
                        org.limeime.data.Related r = originalMap.get(key);
                ...
                for (String key : restoredMap.keySet()) {
                    if (!originalMap.containsKey(key)) {
                        org.limeime.data.Related r = restoredMap.get(key);
    ...
    public void testDBServerRunnableClassesUseDBServerForFileOperations() {
        ...
        try {
            java.lang.Class<?> shareDbRunnableClass = Class.forName("org.limeime.ui.ShareDbRunnable");
            ...
            java.io.File sourceFile = new java.io.File("app/src/main/java/org/limeime/ui/ShareDbRunnable.java");
        ...
        try {
            java.io.File sourceFile = new java.io.File("app/src/main/java/org/limeime/ui/ShareRelatedDbRunnable.java");
            if (sourceFile.exists()) {
                java.util.Scanner scanner = new java.util.Scanner(sourceFile);
                boolean foundDBServerCall = false;
                while (scanner.hasNextLine()) {
    ...
    public void testDBServerMainActivityUsesDBServerForFileOperations() {
        ...
        try {
            java.io.File sourceFile = new java.io.File("app/src/main/java/org/limeime/MainActivity.java");
            if (sourceFile.exists()) {
                java.util.Scanner scanner = new java.util.Scanner(sourceFile);
    ...
    public void testDBServerLimeDBOnlyHasTextFileOperations() {
        ...
        try {
            java.io.File sourceFile = new java.io.File("app/src/main/java/org/limeime/limedb/LimeDB.java");
            if (sourceFile.exists()) {
                java.util.Scanner scanner = new java.util.Scanner(sourceFile);
    ...
    public void testDBServerUIFragmentsUseDBServerForFileOperations() {
        ...
        try {
            java.io.File sourceFile = new java.io.File("app/src/main/java/org/limeime/ui/controller/SetupImController.java");
            if (sourceFile.exists()) {
                java.util.Scanner scanner = new java.util.Scanner(sourceFile);
                boolean foundDBServerCall = false;
                boolean foundDirectFileOps = false;
