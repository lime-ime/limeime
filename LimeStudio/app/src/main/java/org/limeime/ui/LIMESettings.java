...
public class LIMESettings extends AppCompatActivity implements LIMESettingsView {
    ...
    private void onTabSelected(int itemId) {
        ...
        if (itemId == R.id.nav_setup) {
            fragment = org.limeime.ui.view.SetupFragment.newInstance();
        } else if (itemId == R.id.nav_im) {
            fragment = org.limeime.ui.view.TwoPaneHostFragment.newInstance();
        } else if (itemId == R.id.nav_prefs) {
            fragment = org.limeime.ui.view.LimePreferenceFragment.newInstance();
        } else if (itemId == R.id.nav_db) {
            fragment = org.limeime.ui.view.DbManagerFragment.newInstance();
        } else {
            fragment = org.limeime.ui.view.SetupFragment.newInstance();
        }
