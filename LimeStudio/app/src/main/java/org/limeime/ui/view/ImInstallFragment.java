...
public class ImInstallFragment extends Fragment {
        ...
        new Thread(() -> {
            ...
            if (ctrl != null) {
                for (ImFamily family : families) {
                    ...
                    java.util.List<org.limeime.data.ImConfig> cfgList = ctrl.getImConfigFullNameList();
                    if (cfgList != null) {
                        for (org.limeime.data.ImConfig cfg : cfgList) {
    ...
    private List<ImFamily> buildFamilyList() {
        ...
        cj4.add(new CloudVariant("哈哈倉頡", "33,038", "716 KB",
        ...
        tricode.add(new CloudVariant("三碼 v.20260720.3", "14,489", "234 KB",
