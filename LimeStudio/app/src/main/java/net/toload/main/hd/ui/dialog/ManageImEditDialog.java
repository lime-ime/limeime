...
/**
 * Dialog fragment to edit an existing IM mapping record.
 *
 * <p>Displays current code/word/score values and delegates update operations
 * to the hosting `ManageImFragment` via callback methods.
 */
