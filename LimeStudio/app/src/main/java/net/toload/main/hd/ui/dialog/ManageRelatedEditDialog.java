...
/**
 * Dialog fragment to edit or remove an existing related phrase.
 *
 * <p>Shows current pword/cword and score, and delegates update/remove
 * operations to the hosting `ManageRelatedFragment`.
 */
