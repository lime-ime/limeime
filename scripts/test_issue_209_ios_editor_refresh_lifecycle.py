...
class EditorRefreshLifecycleContract(unittest.TestCase):
    ...
    def test_cross_process_ownership_spans_harvest_and_safe_reopen(self):
        ...
        initial_acquire = setup.find("ownership.lock()", factory)
        ...
        hot_acquire = engine.find("ownership.lock()", hot_handle)
        ...
        self.assertIn("flockFunction(descriptor, operation)", self.contract)
    ...
    def test_cross_process_lock_wait_is_bounded(self):
        lock = swift_body(self.contract, "func lock(timeout: TimeInterval) throws")
        ...
        self.assertIn("EditorRefreshLockError.timedOut", lock)
    ...
    def test_settings_explicitly_acquires_without_descriptor_fallback(self):
        ...
        initial_lock = body.find("ownership.lock()", factory)
    ...
    def test_settings_serializes_the_entire_handshake_in_process(self):
        self.assertIn("final class EditorRefreshSessionGate", self.setup)
    ...
    def test_dbserver_only_notifies_after_a_successful_reopen(self):
        ...
        self.assertNotIn("notifyAccessResumed()", suspend)
        ...
        self.assertNotIn("notifyAccessResumed()", failed_reopen)
        self.assertIn("cachedDatasource = reopened", resume)
        self.assertGreater(resume.find("notifyAccessResumed()"),
