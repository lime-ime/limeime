...
public class LimeDB extends SQLiteOpenHelper {
	...
	private final static String ETEN26_CHAR_INITIAL = 	
		"ㄗ|ㄚ|ㄠ|ㄘ|ㄙ|ㄨ|ㄧ|ㄉ|(ㄕ/ㄒ)|ㄜ|ㄈ|(ㄍ/ㄑ)|ㄊ|(ㄐ/ㄓ)|ㄅ|ㄔ|(ㄏ/ㄦ)|ㄋ|ㄩ|ㄖ|ㄇ|ㄞ|ㄎ|ㄛ|ㄌ|ㄆ";
	private final static String ETEN26_CHAR_FINAL = 	
		"ㄟ|ㄚ|ㄠ|ㄝ|ㄙ|ㄨ|ㄧ|˙|(ㄕ/ㄒ)|ㄜ|ˊ|(ㄍ/ㄑ)|ㄤ|(ㄐ/ㄓ)|ㄅ|ㄔ|(ㄏ/ㄦ)|ㄣ|ㄩ|ˇ|ㄢ|ㄞ|ˋ|ㄛ|ㄥ|ㄡ";
	...
	private final static String HSU_CHAR_INITIAL = 	
		"ㄘ|ㄗ|ㄠ|ㄙ|ㄨ|(ㄧ/ㄝ)|ㄉ|(ㄕ/ㄒ)|ㄖ|ㄈ|(ㄔ/ㄑ)|ㄊ|ㄍ|ㄅ|ㄚ|ㄏ|ㄋ|ㄩ|(ㄐ/ㄓ)|ㄇ|ㄞ|ㄎ|ㄡ|(ㄌ/ㄦ)|ㄆ";
	private final static String HSU_CHAR_FINAL = 	
		"ㄟ|ㄗ|ㄠ|˙|ㄨ|(ㄧ/ㄝ)|ˊ|(ㄕ/ㄒ)|ㄖ|ˇ|(ㄔ/ㄑ)|ㄊ|ㄜ|ㄅ|ㄚ|ㄛ|ㄣ|ㄩ|ˋ|ㄢ|ㄞ|ㄤ|ㄡ|(ㄥ/ㄦ)|ㄆ";
