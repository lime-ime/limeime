...
case TRANSACTION_getLoadingMappingCount:
{
data.enforceInterface(DESCRIPTOR);
int _result = this.getLoadingMappingCount();
reply.writeNoException();
reply.writeInt(_result);
return true;
}
case TRANSACTION_getLoadingMappingPercentageDone:
{
data.enforceInterface(DESCRIPTOR);
int _result = this.getLoadingMappingPercentageDone();
reply.writeNoException();
reply.writeInt(_result);
return true;
}
case TRANSACTION_isLoadingMappingFinished:
{
data.enforceInterface(DESCRIPTOR);
boolean _result = this.isLoadingMappingFinished();
reply.writeNoException();
reply.writeInt(((_result)?(1):(0)));
return true;
}
case TRANSACTION_isLoadingMappingThreadAborted:
{
data.enforceInterface(DESCRIPTOR);
boolean _result = this.isLoadingMappingThreadAborted();
reply.writeNoException();
reply.writeInt(((_result)?(1):(0)));
return true;
}
case TRANSACTION_isLoadingMappingThreadAlive:
{
data.enforceInterface(DESCRIPTOR);
boolean _result = this.isLoadingMappingThreadAlive();
reply.writeNoException();
reply.writeInt(((_result)?(1):(0)));
return true;
}
case TRANSACTION_isRemoteFileDownloading:
{
data.enforceInterface(DESCRIPTOR);
boolean _result = this.isRemoteFileDownloading();
reply.writeNoException();
reply.writeInt(((_result)?(1):(0)));
return true;
}
case TRANSACTION_abortLoadMapping:
{
data.enforceInterface(DESCRIPTOR);
this.abortLoadMapping();
reply.writeNoException();
return true;
}
case TRANSACTION_abortRemoteFileDownload:
{
data.enforceInterface(DESCRIPTOR);
this.abortRemoteFileDownload();
reply.writeNoException();
return true;
}
}
...
public int getLoadingMappingCount() throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
int _result;
try {
_data.writeInterfaceToken(DESCRIPTOR);
mRemote.transact(Stub.TRANSACTION_getLoadingMappingCount, _data, _reply, 0);
_reply.readException();
...
public int getLoadingMappingPercentageDone() throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
int _result;
try {
_data.writeInterfaceToken(DESCRIPTOR);
mRemote.transact(Stub.TRANSACTION_getLoadingMappingPercentageDone, _data, _reply, 0);
_reply.readException();
_result = _reply.readInt();
}
finally {
...
public boolean isLoadingMappingFinished() throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
boolean _result;
try {
_data.writeInterfaceToken(DESCRIPTOR);
mRemote.transact(Stub.TRANSACTION_isLoadingMappingFinished, _data, _reply, 0);
_reply.readException();
...
public boolean isLoadingMappingThreadAborted() throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
boolean _result;
try {
_data.writeInterfaceToken(DESCRIPTOR);
mRemote.transact(Stub.TRANSACTION_isLoadingMappingThreadAborted, _data, _reply, 0);
_reply.readException();
_result = (0!=_reply.readInt());
}
finally {
...
public boolean isLoadingMappingThreadAlive() throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
boolean _result;
try {
_data.writeInterfaceToken(DESCRIPTOR);
mRemote.transact(Stub.TRANSACTION_isLoadingMappingThreadAlive, _data, _reply, 0);
_reply.readException();
_result = (0!=_reply.readInt());
}
finally {
...
public boolean isRemoteFileDownloading() throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
boolean _result;
try {
_data.writeInterfaceToken(DESCRIPTOR);
mRemote.transact(Stub.TRANSACTION_isRemoteFileDownloading, _data, _reply, 0);
_reply.readException();
_result = (0!=_reply.readInt());
}
finally {
...
public void abortLoadMapping() throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
_data.writeInterfaceToken(DESCRIPTOR);
mRemote.transact(Stub.TRANSACTION_abortLoadMapping, _data, _reply, 0);
_reply.readException();
}
finally {
_reply.recycle();
...
public void abortRemoteFileDownload() throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
_data.writeInterfaceToken(DESCRIPTOR);
mRemote.transact(Stub.TRANSACTION_abortRemoteFileDownload, _data, _reply, 0);
_reply.readException();
}
finally {
_reply.recycle();
...
static final int TRANSACTION_getLoadingMappingCount = (android.os.IBinder.FIRST_CALL_TRANSACTION + 27);
static final int TRANSACTION_getLoadingMappingPercentageDone = (android.os.IBinder.FIRST_CALL_TRANSACTION + 28);
static final int TRANSACTION_isLoadingMappingFinished = (android.os.IBinder.FIRST_CALL_TRANSACTION + 29);
static final int TRANSACTION_isLoadingMappingThreadAborted = (android.os.IBinder.FIRST_CALL_TRANSACTION + 30);
static final int TRANSACTION_isLoadingMappingThreadAlive = (android.os.IBinder.FIRST_CALL_TRANSACTION + 31);
static final int TRANSACTION_isRemoteFileDownloading = (android.os.IBinder.FIRST_CALL_TRANSACTION + 32);
static final int TRANSACTION_abortLoadMapping = (android.os.IBinder.FIRST_CALL_TRANSACTION + 33);
static final int TRANSACTION_abortRemoteFileDownload = (android.os.IBinder.FIRST_CALL_TRANSACTION + 34);
}
public void loadMapping(java.lang.String filename, java.lang.String tablename) throws android.os.RemoteException;
public void resetMapping(java.lang.String tablename) throws android.os.RemoteException;
public void resetDownloadDatabase() throws android.os.RemoteException;
