...
java.util.List _result = this.query(_arg0, _arg1);
reply.writeNoException();
...
case TRANSACTION_updateMapping:
{
data.enforceInterface(DESCRIPTOR);
java.lang.String _arg0;
_arg0 = data.readString();
...
this.updateMapping(_arg0, _arg1, _arg2, _arg3, _arg4, _arg5);
reply.writeNoException();
return true;
}
...
case TRANSACTION_updateUserDict:
{
data.enforceInterface(DESCRIPTOR);
this.updateUserDict();
reply.writeNoException();
...
public void updateMapping(java.lang.String id, java.lang.String code, java.lang.String word, java.lang.String pword, int score, boolean isDictionary) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
mRemote.transact(Stub.TRANSACTION_updateMapping, _data, _reply, 0);
_reply.readException();
}
finally {
_reply.recycle();
...
public void updateUserDict() throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
_data.writeInterfaceToken(DESCRIPTOR);
mRemote.transact(Stub.TRANSACTION_updateUserDict, _data, _reply, 0);
_reply.readException();
}
finally {
_reply.recycle();
...
static final int TRANSACTION_updateMapping = (android.os.IBinder.FIRST_CALL_TRANSACTION + 6);
static final int TRANSACTION_addUserDict = (android.os.IBinder.FIRST_CALL_TRANSACTION + 7);
static final int TRANSACTION_updateUserDict = (android.os.IBinder.FIRST_CALL_TRANSACTION + 8);
...
static final int TRANSACTION_clear = (android.os.IBinder.FIRST_CALL_TRANSACTION + 13);
static final int TRANSACTION_queryDictionary = (android.os.IBinder.FIRST_CALL_TRANSACTION + 14);
